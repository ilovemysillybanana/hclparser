...
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 11 ->
    yystate(30, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 101 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 115 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
...
yystate(11, [10|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line+1, Tlen+1, 1, Tlen);
...
yyaction_8(TokenChars, TokenLine) ->
     { token, { equal, TokenLine, list_to_atom (TokenChars) } } .
